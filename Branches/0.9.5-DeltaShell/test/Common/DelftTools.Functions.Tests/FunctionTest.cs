...
namespace DelftTools.Functions.Tests
{
    ...
    public class FunctionTest
    {
        ...
        public void ArgumentValuesInsertAt()
        {
            ...
            Assert.AreEqual(y.DefaultValue, y.Values[1]);
        ...
        [Test]
        public void AssignIntToDoubleComponent()
        {
        ...
        public void FunctionValuesChanged()
        {
            ...
            int callCount = 0;
            function.ValuesChanged += delegate(object sender, FunctionValuesChangedEventArgs e)
                                          {
        ...
        public void FunctionValuesChangedForDependendVariable()
        {
            ...
            int callCount = 0;
            dependend.ValuesChanged += delegate(object sender, FunctionValuesChangedEventArgs e)
                                           {
        ...
        {
            var function = new Function();
            Assert.AreEqual(new object[] {function.Store, function}, function.GetAllItemsRecursive().ToArray());
        }
        ...
        [Ignore("Waaaay to complex. Implement when needed.")]
        ...
        public void SetALotOfValuesWithoutEvents()
        {
            ...
            log.DebugFormat("Set {0} values in {1} ms", count, stopwatch.Elapsed.TotalMilliseconds);
            Assert.Less(stopwatch.Elapsed.TotalMilliseconds, 3000);
        ...
        public void ChangeLastValueToFirst()
        {
            ...
            Assert.AreEqual(new[] { 0, 1, 2 }, x.Values);
            Assert.AreEqual(new[] { 50, 20, 30 }, y.Values);
        }
    }
