...
/* move to TestPlugin1.Tests
                ...
                public void LinkModelDataAndRun()
                {
                    ...
                    Assert.AreEqual(ActivityStatus.Running, compositeModel.Status);
                    Assert.AreEqual(ActivityStatus.Running, sourceModel.Status);
                    Assert.AreEqual(ActivityStatus.Running, targetModel.Status);
