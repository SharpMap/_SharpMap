    ...
    public class RegularGridCoverageRenderer : IFeatureRenderer
    {
                                             ...
                                             PixelFormat pixelFormat, IVariableFilter[] filters, int xWidth, int yWidth)
        {
            ...
            else if (grid.Components[0].ValueType == typeof (Byte))
            {
                ...
                return bitmap;
                //FillBitmap<Byte>(gridLayer, grid, bitmap, pixelFormat);
            }
            else
            {
            ...
            where T : IComparable, IComparable<T>
        {
            ...
            if (gridLayer.Theme == null)
            {
                ...
                gridLayer.Theme = GenerateDefaultTheme(gridValues, gridCoverage.Components[0].Name,
                                                     ...
                                                     object minValue, object maxValue)
        {
            ...
            var minStyle = new VectorStyle {GeometryType = typeof (IPolygon)};
            var maxStyle = new VectorStyle {GeometryType = typeof (IPolygon)};
