...
namespace DelftTools.Functions
{
    ...
    /// 
    /// TODO: migrate to use collection of IVariableValueStore (or/and implement store-specific IMultiDimensionalArray, then views will work also)
    ...
    /// </summary>
    public interface IFunctionStore : IUnique<long>, INotifyCollectionChanged, ICloneable
    {
        /// <summary>
        ...
        /// <param name="filters"></param>
        /// <returns></returns>
        IMultiDimensionalArray<T> GetVariableValues<T>(IVariable function, params IVariableFilter[] filters) where T : IComparable;
        ...
        event EventHandler<FunctionValuesChangedEventArgs> FunctionValuesChanged;
        event EventHandler<FunctionValuesChangedEventArgs> FunctionValuesChanging;
        ...
        T GetMaxValue<T>(IVariable variable) where T:IComparable;
        T GetMinValue<T>(IVariable variable) where T : IComparable;
