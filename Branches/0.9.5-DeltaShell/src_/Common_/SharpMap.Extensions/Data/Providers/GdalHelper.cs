 ...
 */
        ...
        public static void CheckAndFixAscHeader(string path)
        {
            ...
            using (TextReader reader = new StreamReader(path))
            {
                ...
                hasCommentedLine = lineString.StartsWith("/*");
            }
            if (hasCommentedLine)
            {
        ...
        public static Driver GetDriverByName(string path)
        {
            return Gdal.GetDriverByName(GetDriverName(path));
        }
        ...
        public static bool IsCreateCopyOnlySupported(Driver gdalDriver)
        {
        ...
        {
            var destinationTypeList = gdalDriver.GetMetadataItem("DMD_CREATIONDATATYPES", null).Split(new char[] {' '});
