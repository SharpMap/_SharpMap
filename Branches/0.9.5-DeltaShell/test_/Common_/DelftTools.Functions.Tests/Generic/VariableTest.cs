...
namespace DelftTools.Functions.Tests.Generic
{
    ...
    public class VariableTest
    {
        ...
        [Test, NUnit.Framework.Category("Performance")]
        public void PerformanceAddValuesToArgument_WithEvents_IndependentVariable()
        {
            IVariable<double> x = new Variable<double>("x");
        ...
        public void InsertingValuesAreSortedAutomatically()
        {
            ...
            IVariable<string> strings = new Variable<string>("strings");
        ...
        public class A: INotifyPropertyChanged, IComparable
        {
            private string name;
