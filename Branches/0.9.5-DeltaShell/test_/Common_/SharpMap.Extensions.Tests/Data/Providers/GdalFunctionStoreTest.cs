...
namespace SharpMap.Extensions.Tests.Data.Providers
{
    ...
    public class GdalFunctionStoreTest
    {
        ...
        private readonly string dataPath =
            TestHelper.GetTestDataPath(@"DeltaShell\DeltaShell.Plugins.SharpMapGis.Tests\");
            
        private readonly string rasterDataPath =
            TestHelper.GetTestDataPath(@"DeltaShell\DeltaShell.Plugins.SharpMapGis.Tests\RasterData\");
