...
namespace NetTopologySuite.Extensions.Coverages
{
    ...
    public abstract class Coverage : Function, ICoverage
    {
        ...
        private const string StandardNameTime = "time";
        ...
        /// <returns></returns>
        public abstract T Evaluate<T>(ICoordinate coordinate) where T : IComparable;
        ...
        /// <param name="y"></param>
        /// <returns></returns>
        public abstract T Evaluate<T>(double x, double y) where T : IComparable;
