...
namespace SharpMap.Layers
{
	...
	public class WmsLayer : SharpMap.Layers.Layer
	{
        ...
        private void Initialize()
        {
            ...
            if (System.Web.HttpContext.Current != null && System.Web.HttpContext.Current.Cache["SharpMap_WmsClient_" + _url] != null)
            {
                wmsClient = (SharpMap.Web.Wms.Client)System.Web.HttpContext.Current.Cache["SharpMap_WmsClient_" + _url];
            }
            else
            {
                wmsClient = new SharpMap.Web.Wms.Client(_url, _Proxy);
                if (System.Web.HttpContext.Current != null)
                    System.Web.HttpContext.Current.Cache.Insert("SharpMap_WmsClient_" + _url, wmsClient, null,
                        System.Web.Caching.Cache.NoAbsoluteExpiration, _cachetime);
            }
        ...
        private IList<string> _LayerList;
