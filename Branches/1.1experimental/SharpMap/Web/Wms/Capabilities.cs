...
namespace SharpMap.Web.Wms
{
    ...
    public class Capabilities
    {
        ...
        public static XmlDocument GetCapabilities(HttpContext context, SharpMap.Map map, WmsServiceDescription serviceDescription)///John Diss: added context param. this is required when calling from an async http handler
        {
            ...
            //Build Service node
            RootNode.AppendChild(GenerateServiceNode(context, ref serviceDescription, capabilities));
        ...
        private static XmlNode GenerateServiceNode(HttpContext context, ref WmsServiceDescription serviceDescription, XmlDocument capabilities)
        {
        ...
        private static XmlNode GenerateCapabilityNode(HttpContext context, SharpMap.Map map, XmlDocument capabilities)
        {
            string OnlineResource = "";
            string port = context.Request.Url.IsDefaultPort ? "" : ":" + context.Request.Url.Port.ToString();
            OnlineResource = context.Server.HtmlEncode("http://" + context.Request.Url.Host + port + context.Request.Url.AbsolutePath);
