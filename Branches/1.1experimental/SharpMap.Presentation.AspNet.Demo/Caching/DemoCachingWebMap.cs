...
namespace SharpMap.Presentation.AspNet.Demo.Caching
{
        ...
        : WebMapBase
    {
        ...
        {
            return Container.Instance.Resolve<IMapRenderer>(); //we will just use the default
        }
        ...
        {
            return Container.Instance.Resolve<IMapCacheProvider>("cachingDemoCacheProvider");
        }
