...
namespace GeoAPI.Geometries
{
    ...
    //    public static Point GetCentroid(this Envelope self)
    //    {
    //        return new Point(new Coordinate(self.MinX + self.Width * 0.5d,  self.MinY + self.Height * 0.5d));
    //    }
    ...
    //    /// <summary>
    //    /// Computes the minimum distance between this <see cref="Envelope"/> and a <see cref="Point"/>
    //    /// </summary>
    //    /// <param name="p"><see cref="Point"/> to calculate distance to.</param>
    //    /// <returns>Minimum distance.</returns>
    //    public static double Distance(this Envelope self, Point p)
    //    {
    //        var ret = 0.0;
...
namespace GeoAPI.Geometries
{
    ...
    /// </remarks>
    [Serializable]
    public class Envelope : IEquatable<BoundingBox>
    {
        private Point _max;
        private Point _min;
