...
namespace SharpMap.Geometries
{
    ...
    public class GeometryCollection : Geometry, IGeometryCollection, IEnumerable<Geometry>
    {
        ...
        {
            get { return _geometries.ToArray(); }
        }
        ...
        public virtual IGeometry this[int index]
        {
        ...
        public override Dimension Dimension
        {
            get
            {
                Dimension dim = Dimension.Dontcare;
        ...
        /// <summary>
        /// The minimum bounding box for this Geometry, returned as a GeoAPI.Geometries.Envelope.
        /// </summary>
        /// <returns></returns>
        public override Envelope GetBoundingBox()
        {
            if (Collection.Count == 0)
                return null;
            var b = _geometries[0].GetBoundingBox();
            for (int i = 0; i < Collection.Count; i++)
                b = b.Join(_geometries[i].GetBoundingBox());
            return b;
        }
