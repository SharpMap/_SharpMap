...
// ReSharper restore InconsistentNaming
        {
            ...
            /// <param name="lineSegFrom"></param>
            /// <param name="lineSegTo"></param>
            /// <returns>
            /// A Coordinate which is the closest point on the line segment to the point p.
            /// </returns>
            public static Coordinate ClosestPoint(Coordinate p, Coordinate lineSegFrom, Coordinate lineSegTo)
            {
            ...
            /// <param name="lineSegTo"></param>
            /// <returns></returns>
            public static Coordinate Project(Coordinate p, Coordinate lineSegFrom, Coordinate lineSegTo)
            {
                if (p.Equals(lineSegFrom) || p.Equals(lineSegTo))
                    return new Coordinate(p.X, p.Y);

                var r = ProjectionFactor(p, lineSegFrom,  lineSegTo);
                var coord = new Coordinate { X = lineSegFrom.X + r * (lineSegTo.X - lineSegFrom.X), Y = lineSegFrom.Y + r * (lineSegTo.Y - lineSegFrom.Y) };
                return coord;
            }
            ...
            /// <param name="lineSegTo"></param>
            /// <returns></returns>
            public static double ProjectionFactor(Coordinate p, Coordinate lineSegFrom, Coordinate lineSegTo)
            {
