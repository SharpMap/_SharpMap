    ...
    public class TileCacheFileStorage : ITileCache
    {
        ...
        private string GetFileName(Envelope boundingBox)
        {
            return String.Format("{0}/{1}_{2}_{3}_{4}.{5}", directory,
                                 boundingBox.MinX.ToString("r", cultureInfo), boundingBox.MaxY.ToString("r", cultureInfo),
                                 boundingBox.MaxX.ToString("r", cultureInfo),
                                 boundingBox.MinY.ToString("r", cultureInfo),
                                 "png");
        }
    }
}