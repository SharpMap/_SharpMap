    ...
    public static class WfsSample
    {
        public static Map InitializeMap()
        {
            try
            {
                ...
                Layer layer1 = new Layer("States");
                Layer layer2 = new Layer("SelectedStatesAndHousholds");
                Layer layer3 = new Layer("New Jersey");
                Layer layer4 = new Layer("Roads");
                Layer layer5 = new Layer("Landmarks");
                Layer layer6 = new Layer("Poi");
