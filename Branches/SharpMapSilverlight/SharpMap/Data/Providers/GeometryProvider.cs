...
namespace SharpMap.Data.Providers
{
	...
	/// </example>
	/// </remarks>
	public class GeometryProvider : SharpMap.Data.Providers.IProvider
	{
		...
		public BoundingBox GetExtents()
		{
			if (_Geometries.Count == 0)
				return null;
			BoundingBox box = _Geometries[0].GetBoundingBox();
			for (int i = 1; i < _Geometries.Count; i++)
				box.Join(_Geometries[i].GetBoundingBox());
			return box;
		}
