...
namespace SharpMap.Data.Providers.Pooling
{
	...
	internal class Connector
	{
		...
		private SharpMap.Data.Providers.IVectorProvider _Provider;
		/// <summary>
		/// Used to connect to the data source. 
		/// </summary>
		internal SharpMap.Data.Providers.IVectorProvider Provider
		{
			...
			set
			{
				if (this.InUse)
				{
					throw new Exception("Provider cannot be modified if connection is open.");
				}
				_Provider = value;
			}
		}
		...
		/// </summary>
		internal Connector(IVectorProvider provider, bool Shared)
		{
