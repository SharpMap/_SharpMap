...
namespace SharpMap.Data.Providers
{
    ...
    public class MsSql : IProvider, IDisposable
	{
		...
		public List<Geometries.Geometry> GetGeometriesInView(SharpMap.Geometries.BoundingBox bbox)
		{
			...
			{
				string BoxIntersect = "Not (Envelope_MinX> " + bbox.Max.X + " OR " +
					 "Envelope_MaxX < " + bbox.Min.X + " OR " +
					 "Envelope_MinY > " + bbox.Max.Y + " OR " +
					 "Envelope_MaxY < " + bbox.Min.Y + ")";
		...
		{
			return "(Envelope_MinX < " + bbox.Max.X.ToString(SharpMap.Map.numberFormat_EnUS) + " AND " +
					"Envelope_MaxX > " + bbox.Min.X.ToString(SharpMap.Map.numberFormat_EnUS) + " AND " +
					"Envelope_MinY < " + bbox.Max.Y.ToString(SharpMap.Map.numberFormat_EnUS) + " AND " +
					"Envelope_MaxY > " + bbox.Min.Y.ToString(SharpMap.Map.numberFormat_EnUS) + ")";
		}
