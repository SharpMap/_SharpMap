...
namespace SharpMap.Data.Providers
{
	...
	{
        FeatureDataTable GetFeaturesInView(BoundingBox envelope);
		/// <summary>
        ...
        IList<IGeometry> GetGeometriesInView(BoundingBox bbox);
		...
		/// <returns></returns>
		System.Collections.Generic.List<uint> GetObjectIDsInView(BoundingBox bbox);
