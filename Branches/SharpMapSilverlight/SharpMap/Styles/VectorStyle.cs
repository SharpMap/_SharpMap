...
namespace SharpMap.Styles
{
    ...
    public class VectorStyle : Style
    {
        ...
        private Offset _SymbolOffset = new Offset();
        ...
        public VectorStyle()
        {
            this.Outline = new Pen() { Color = new Color(), Width = 1 };
            this.Line = new Pen() { Color = new Color(), Width = 1 };
            this.Fill = new Brush() { Fill = new Color() };
