...
using System.Text;
#if !CFBuild //System.Runtime.Serialization doesn't exist in CF Lost Functionality.
...
namespace SharpMap.Geometries
{
	...
	/// </summary>
	/// <remarks>
    /// <para>The instantiable subclasses of Geometry defined in the specification are restricted to 0, 1 and twodimensional
	...
	public abstract class Geometry : IGeometry, IEquatable<Geometry>
	{
		...
		{
            throw new NotImplementedException("need to port");
			//!!!return ProjNet.Converters.WellKnownText.GeometryToWKT.Write(this);
		}
		...
		{
            throw new NotImplementedException("need to port");
			//!!!return WellKnownBinary.GeometryToWKB.Write(this);
		}
		...
		public static Geometry GeomFromText(string WKT, int SRID)
		{
			...
			//!!!Geometry g = ProjNet.Converters.WellKnownText.GeometryFromWKT.Parse(WKT);
            //!!!g.SRID = SRID;
            //!!!return g;
		}
		...
		/// <param name="SRID">Spatial Reference ID</param>
		/// <returns></returns>
		public static Geometry GeomFromWKB(byte[] WKB, int SRID)
		{
            throw new NotImplementedException("Not ported yet");
			//!!!Geometry g = SharpMap.Converters.WellKnownBinary.GeometryFromWKB.Parse(WKB);
            //!!!g.SRID = SRID;
            //!!!return g;
		}
