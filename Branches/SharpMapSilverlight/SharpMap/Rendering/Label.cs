...
namespace SharpMap.Rendering
{
	...
	/// </summary>
	internal class LabelBox : IComparable<LabelBox>
	{
		/// <summary>
	...
	/// </summary>
	internal class Label : IComparable<Label>, IComparer<Label>
    {
		...
		/// <param name="collisionbox">Box around label for collision detection</param>
		/// <param name="style">The style of the label</param>
		public Label(string text, System.Drawing.Point labelpoint, float rotation, int priority, LabelBox collisionbox, SharpMap.Styles.LabelStyle style)
		{
			_Text = text;
			_LabelPoint = labelpoint;
			_Rotation = rotation;
...
#else
        private System.Drawing.Point _LabelPoint;

        /// <summary>
        /// Label position
        /// </summary>
        public System.Drawing.Point LabelPoint
        {
            get { return _LabelPoint; }
            set { _LabelPoint = value; }
        }
