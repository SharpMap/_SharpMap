...
namespace SharpMap.CoordinateSystems
{
	...
	public class HorizontalDatum : Datum, IHorizontalDatum
	{
		...
		public static HorizontalDatum WGS84
		{
			get
			{
				return new HorizontalDatum(SharpMap.CoordinateSystems.Ellipsoid.WGS84, 
					null, DatumType.HD_Geocentric, "World Geodetic System 1984", "EPSG", 6326, String.Empty, String.Empty, 
		...
		public static HorizontalDatum ETRF89
		{
			get
			{
				return new HorizontalDatum(SharpMap.CoordinateSystems.Ellipsoid.GRS80, null, DatumType.HD_Geocentric, 
