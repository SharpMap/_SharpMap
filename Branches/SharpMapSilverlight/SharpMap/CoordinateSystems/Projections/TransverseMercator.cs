...
namespace SharpMap.CoordinateSystems.Projections
{
  ...
  -----------------------------------------------------*/
		...
		{
			ProjectionParameter par_semi_major = _Parameters.Find(delegate(ProjectionParameter par) { return par.Name.Equals("semi_major", StringComparison.OrdinalIgnoreCase); });
			ProjectionParameter par_semi_minor = _Parameters.Find(delegate(ProjectionParameter par) { return par.Name.Equals("semi_minor", StringComparison.OrdinalIgnoreCase); });
			ProjectionParameter par_scale_factor = _Parameters.Find(delegate(ProjectionParameter par) { return par.Name.Equals("scale_factor", StringComparison.OrdinalIgnoreCase); });
			ProjectionParameter par_central_meridian = _Parameters.Find(delegate(ProjectionParameter par) { return par.Name.Equals("central_meridian", StringComparison.OrdinalIgnoreCase); });
			ProjectionParameter par_latitude_of_origin = _Parameters.Find(delegate(ProjectionParameter par) { return par.Name.Equals("latitude_of_origin", StringComparison.OrdinalIgnoreCase); });
			ProjectionParameter par_false_easting = _Parameters.Find(delegate(ProjectionParameter par) { return par.Name.Equals("false_easting", StringComparison.OrdinalIgnoreCase); });
			ProjectionParameter par_false_northing = _Parameters.Find(delegate(ProjectionParameter par) { return par.Name.Equals("false_northing", StringComparison.OrdinalIgnoreCase); });
