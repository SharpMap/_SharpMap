...
namespace SharpMap.CoordinateSystems.Projections
{
	...
	internal class Mercator : MapProjection
	{
			...
			: base(parameters, isInverse)
		{
			...
			ProjectionParameter scale_factor = _Parameters.Find(delegate(ProjectionParameter par) { return par.Name.Equals("scale_factor", StringComparison.OrdinalIgnoreCase); });
