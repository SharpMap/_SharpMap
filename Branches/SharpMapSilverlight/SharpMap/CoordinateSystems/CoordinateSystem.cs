...
namespace SharpMap.CoordinateSystems
{
	...
	public abstract class CoordinateSystem : Info, ICoordinateSystem
	{
		...
		{
			throw new InvalidOperationException("No unit information on coordinate system");
		}
		...
		/// <summary>
		/// Gets the number of axes defined
		/// </summary>
		public int NumAxes
		{
			get
			{
				if (_AxisInfo == null) return 0;
				else return _AxisInfo.Count;
			}
		}
