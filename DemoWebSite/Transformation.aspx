<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Transformation.aspx.cs" Inherits="Transformation" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>On-the-fly transformation</title>
</head>
<body>
<h2>On-the-fly transformation</h2>
<form id="Form1" runat="server">
    <div>
        ...
        <asp:DropDownList ID="ddlProjection" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlProjection_SelectedIndexChanged">
			<asp:ListItem Value="Pseudo">Pseudo Plate Carrée (default / no projection applied)</asp:ListItem>
